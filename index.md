...
<div style="display: flex; justify-content: center; gap: 2rem; flex-wrap: wrap; text-align: center;">
  ...
  <div style="margin-bottom: 1.5rem;">
    ...
    <div style="display: flex; justify-content: center; gap: 1rem; flex-wrap: wrap;">
      ...
      <img src="/assets/images/bluerov5.jpg" alt="BlueRov2 5" style="height: 250px; border-radius: 0;">
      <img src="/assets/images/bluerov6.jpg" alt="BlueRov2 6" style="height: 250px; border-radius: 0;">
    </div>
  </div>
